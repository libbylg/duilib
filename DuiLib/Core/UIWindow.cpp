...
#define MSGDEF(x) if(uMsg==x) return _T(#x)
    ...
    static const DUI_MSGMAP_ENTRY* DuiFindMessageEntry(const DUI_MSGMAP_ENTRY * lpEntry, struct TNOTIFY_UI& msg)
    {
    ...
    void CNotifyPump::NotifyPump(struct TNOTIFY_UI& msg)
    {
        ///遍历虚拟窗口
